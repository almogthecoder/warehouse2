      ...
      <button
        ...
        className={cn(
          "inline-flex items-center justify-center font-medium rounded-lg transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed",
          {
            ...
            "bg-violet-600 text-white hover:bg-violet-700 focus:ring-violet-500": variant === "secondary",
            "border border-indigo-300 text-indigo-700 hover:bg-indigo-50 focus:ring-indigo-500 bg-white": variant === "outline",
            "text-indigo-700 hover:bg-indigo-50 focus:ring-indigo-500": variant === "ghost",
